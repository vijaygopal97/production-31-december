...
const createTestInterviewerCATI = async () => {
  try {
    ...
    const email = 'testinterviewer3@gmail.com';
    const password = 'Test@1234';
    const phone = '9958233649';
    ...
    // Create new user with CATI interview mode
    const newUser = new User({
      ...
      interviewModes: 'CATI (Telephonic interview)', // CATI mode
      canSelectMode: false,
      ...
      interviewerProfile: {
        ...
        surveyExperienceYears: 4,
        surveyExperienceDescription: 'Experienced in telephonic surveys and CATI operations',
    ...
    await newUser.save();
    console.log('\n✅ Test CATI interviewer created successfully!');
    console.log('\n📋 Login Credentials:');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    ...
    console.error('Error creating test CATI interviewer:', error);
    process.exit(1);
  }
};

createTestInterviewerCATI();
